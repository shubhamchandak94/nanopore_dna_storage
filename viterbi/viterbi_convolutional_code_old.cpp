/*
This does not seem to performing correct decoding.
Works well when we allow transitions from A->A (etc.) that 
correspond to change in states, which is ideally not allowed in CTC.
So moving to other idea.
*/ 
