...
HDF5_INPUT=$ROOT_PATH/raw_signal/$REPLICATE/raw_signal_2.hdf5
DIRNAME=$ROOT_PATH/decoded_lists/$REPLICATE/exp_2_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/read_ids/$REPLICATE/exp_2_read_ids.10000.txt
mkdir -p $DIRNAME
