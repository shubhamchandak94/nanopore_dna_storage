...
ROOT_PATH=/mnt/ix1/Projects_lite/20180528_HJL_DGI/riskyKmer/shubham/nanopore_dna_storage/data_20210205_MIN_0952/
...
HDF5_INPUT=$ROOT_PATH/raw_signal/$REPLICATE/raw_signal_0.hdf5
DIRNAME=$ROOT_PATH/decoded_lists/$REPLICATE/exp_0_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/read_ids/$REPLICATE/exp_0_read_ids.10000.txt
mkdir -p $DIRNAME
