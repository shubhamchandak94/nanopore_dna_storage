...
HDF5_INPUT=$ROOT_PATH/data/raw_signal/raw_signal_14.hdf5
DIRNAME=$ROOT_PATH/data/decoded_lists/exp_14_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/data/read_ids/exp_14_read_ids.10000.txt
mkdir -p $DIRNAME
...
--rate_conv 5 \
--list_size 16 \
--start_barcode TATGTACTAGCTAGTCACGCACACA \
--end_barcode ACACTGCTGTGTCGTCAGTCTCACG \
--num_threads 8 \
