...
HDF5_INPUT=$ROOT_PATH/data/raw_signal/raw_signal_12.hdf5
DIRNAME=$ROOT_PATH/data/decoded_lists/exp_12_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/data/read_ids/exp_12_read_ids.20000.txt
mkdir -p $DIRNAME
...
--rate_conv 5 \
--list_size 32 \
--start_barcode CGTATGCTCGTATGAGCATAGAGTG \
--end_barcode GTCGTCTAGATGTATCGATGTGATG \
--num_threads 4 \
