...
HDF5_INPUT=$ROOT_PATH/data/raw_signal/raw_signal_7.hdf5
DIRNAME=$ROOT_PATH/data/decoded_lists/exp_7_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/data/read_ids/exp_7_read_ids.20000.txt
mkdir -p $DIRNAME
...
--rate_conv 7 \
--list_size 32 \
--start_barcode CGCTGCAGTCTATCTCTCTGTACAT \
--end_barcode GCTAGTAGAGATACATCTCGCGAGA \
--num_threads 6 \
