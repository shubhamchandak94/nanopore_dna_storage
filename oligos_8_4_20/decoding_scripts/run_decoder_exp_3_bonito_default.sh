...
HDF5_INPUT=$ROOT_PATH/data/raw_signal/raw_signal_3.hdf5
DIRNAME=$ROOT_PATH/data/decoded_lists/exp_3_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/data/read_ids/exp_3_read_ids.20000.txt
mkdir -p $DIRNAME
