...
HDF5_INPUT=$ROOT_PATH/data/raw_signal/raw_signal_10.hdf5
DIRNAME=$ROOT_PATH/data/decoded_lists/exp_10_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/data/read_ids/exp_10_read_ids.20000.txt
mkdir -p $DIRNAME
...
--rate_conv 3 \
--list_size 32 \
--start_barcode GTCGTACTGTGACTCTCACTCGTGC \
--end_barcode TCTGCGTACGTGTCGACACATGTCT \
--num_threads 6 \
