...
HDF5_INPUT=$ROOT_PATH/data/raw_signal/raw_signal_11.hdf5
DIRNAME=$ROOT_PATH/data/decoded_lists/exp_11_bonito_default_bcp_0.6/
READ_ID_FILE=$ROOT_PATH/data/read_ids/exp_11_read_ids.10000.txt
mkdir -p $DIRNAME
...
--rate_conv 3 \
--list_size 16 \
--start_barcode CGCACGCATATCACGATGAGTAGCT \
--end_barcode TGCGAGACATATAGTAGCTCTCTCA \
--num_threads 8 \
