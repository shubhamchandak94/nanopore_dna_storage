...
JSON_FILE_WITH_RAW_DATA = '/raid/nanopore/shubham/20190306_2044_MN19956_FAK54380_79e29d9c/conv_m11_nosync/merged_rl_250_no_reverse.ids.shuf.20000.raw.json'
RAPTOR_HEADER_FILE = '/raid/nanopore/shubham/Nanopore-DNA-storeage/oligos_2_7_19/code/conv_m11_nosync_init_64payload_init10010110001_oligos_raptor_header'
DECODED_FILE = 'conv_m11_nosync_decoded_l1.bz2'
...
NUM_READS_BEFORE_RAPTOR = 900 # number of unique reads to obtain before calling raptor decoding (should be slightly larger than the optimum to guarantee recovery
MEM_CONV = 11
SYNC_MARKER = ''
...
tmpfile = 'tmpfile.m11_nosync.l_64.'+str(np.random.randint(1000000))
